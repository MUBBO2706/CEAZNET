...
export type View = 'home' | 'translator' | 'molecule-viewer' | 'live-conversation' | 'explore' | 'article-reader' | 'settings' | 'profile' | 'notes' | 'finance' | 'dairy' | 'about' | 'features' | 'voice-history' | 'voice-settings' | 'gallery' | 'support' | 'privacy-policy' | 'terms-of-service' | 'shared-note' | 'not-found';
