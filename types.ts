...
export type ChatModel = 'gemini-3.8-flash' | 'gemini-3.7-flash' | 'gemini-3.6-flash' | 'gemini-3.5-flash' | 'gemini-3.5-flash-lite' | 'gemini-3.1-flash-lite' | 'gemini-3.1-pro-preview' | 'gemini-3-flash-preview' | 'gemini-2.5-pro' | 'gemini-2.5-flash' | 'gemini-2.5-flash-lite';
export type Tool = 'smart' | 'webSearch' | 'thinking' | 'urlReader' | 'chemistry';
export type View = 'home' | 'translator' | 'molecule-viewer' | 'live-conversation' | 'explore' | 'article-reader' | 'settings' | 'profile' | 'notes' | 'finance' | 'finance-categories' | 'dairy' | 'about' | 'features' | 'voice-history' | 'voice-settings' | 'gallery' | 'support' | 'privacy-policy' | 'terms-of-service' | 'shared-note' | 'not-found';
...
export interface VoicePersona {
    ...
    icon: string;
    prompt: string;
    voice: VoiceName | 'user-selectable';
}
