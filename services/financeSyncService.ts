...
const generateSnapshotHeader = (transactions: Transaction[], profileName: string) => {
    ...
    return `<!-- REPORT_HEADER_START --><h1 class="text-xl font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span class="f-icon fi-wallet text-indigo-500"></span> ${profileName} Report</h1><hr class="my-1.5 border-0 border-t-[0.5px] border-gray-200/50 dark:border-white/10" /><!-- REPORT_HEADER_END -->` +
        statsCards +
        ...
        insightsGrid +
        `<hr class="my-1.5 border-0 border-t-[0.5px] border-gray-200/50 dark:border-white/10" />` +
        `<!-- REPORT_FOOTER_START --><div class="flex flex-col gap-1 mt-1.5 mb-1.5"><span class="text-[10px] text-gray-400 leading-none">Last Synced: ${dateStr}</span><hr class="my-0 border-0 border-t-[0.5px] border-gray-200/50 dark:border-white/10" /></div><!-- REPORT_FOOTER_END -->`;
};
