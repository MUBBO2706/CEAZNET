...
const AboutView: React.FC<AboutViewProps> = ({ onNavigate }) => {
    ...
    const scrollToSection = (id: string) => {
        ...
        setTimeout(() => {
            ...
            if (element) {
                ...
                // Highlight text instead of background
                const textElements = element.querySelectorAll('h2, h3, p, li, span, strong');
                textElements.forEach(el => {
                    el.classList.add('!text-amber-600', 'dark:!text-amber-400', 'transition-colors', 'duration-1000');
                });
    ...
    return (
        <main className="relative z-10 h-full overflow-y-auto bg-transparent scrollbar-hide pt-16 md:pt-24 px-4 md:px-6 pb-6 dev-console-spacing-pb">
            <div className="w-full max-w-none mx-auto">
                ...
                {/* --- CONTENT TIMELINE --- */}
                <div className="relative ml-2.5 md:ml-3.5 space-y-2 mt-4">
                    ...
                    {/* About the Creator */}
                    <section id="creator" className="relative pl-6 md:pl-8 scroll-mt-48 group rounded-xl p-2 -ml-2 transition-colors">
                        <div className="absolute left-[1.5px] top-3 w-3.5 h-3.5 rounded-full border-[3px] border-[#F9F6F2] dark:border-[#191B1A] bg-neutral-300 dark:bg-neutral-700 group-hover:bg-amber-500 transition-colors duration-500 z-10" />
                        ...
                        <div className="prose prose-sm dark:prose-invert max-w-none text-neutral-600 dark:text-neutral-300 leading-relaxed">
                            <p className="mb-2">
                                <strong>Mubasshir</strong> is a 20-year-old developer from Mumbai, India, driven by curiosity and a genuine interest in understanding how things work. He enjoys turning ideas into practical software, with a focus on clean code, minimal design systems, responsive layouts, and interfaces that feel natural rather than overcomplicated.
                            </p>
                            <p className="mb-2">
                                He is the creator of <strong>Ceaznet</strong>, an engineered personal operating system that brings real-time voice, finance, and dynamic notes together into a cohesive digital workspace.
                            </p>
                            <p>
                                Beyond building software, he enjoys exploring new ideas, refining details, and continuously improving the way he learns, designs, and builds. His work reflects a simple philosophy: technology should be thoughtfully engineered, purposeful, and easy to live with.
                            </p>
                        </div>
                    </section>
