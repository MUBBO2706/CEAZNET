...
const HomeView: React.FC<HomeViewProps> = ({ onNavigate, user, userProfile, exploreArticles }) => {
    ...
    return (
        <div className="p-6 pt-20 md:p-12 md:pt-24 w-full max-w-[1600px] mx-auto h-full overflow-y-auto scrollbar-hide dev-console-spacing-pb">
            
            {/* Dynamic Animated Banner Section */}
            <div className="mb-10 w-full max-w-7xl mx-auto">
                <div className="relative w-full h-[18rem] md:h-[22rem] lg:h-[24rem] xl:h-[26rem] rounded-[2rem] overflow-hidden shadow-lg group cursor-pointer" onClick={() => onNavigate(apps[currentAdIndex].id as View)}>
