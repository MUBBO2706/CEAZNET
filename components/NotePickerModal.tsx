        ...
        <div className={`fixed inset-0 z-[60] flex items-center justify-center p-4 transition-all duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-4 pt-2 space-y-2 scrollbar-hide">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-8 text-center" style={{ color: 'var(--notes-loader-text)' }}>
                            <Loader className="w-6 h-6 animate-spin mb-2" style={{ color: 'var(--notes-loader-spinner)' }} />
                            <p className="text-xs font-medium tracking-tight">Loading notes...</p>
                        </div>
