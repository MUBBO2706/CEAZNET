...
export const CustomDropdown: React.FC<CustomDropdownProps> = ({
  ...
  const panelContent = isOpen ? createPortal(
    <div
      ref={panelRef}
      className={`custom-dropdown-panel ${isOpen ? 'open' : ''} bg-white dark:bg-[#18181b] border border-neutral-200 dark:border-neutral-800 rounded-xl py-1 relative z-[999999] overflow-y-auto max-h-[240px]`}
      role="listbox"
      style={{
        position: 'fixed',
