...
const FinanceCalendar: React.FC<FinanceCalendarProps> = ({ 
    ...
    const prevMonth = () => {
        ...
        setCurrentDate(newD);
        onMonthChange?.(newD.getFullYear(), newD.getMonth() + 1);
    };
    ...
    const dailyStats = useMemo(() => {
        ...
        if (dailyData && dailyData.length > 0) {
            dailyData.forEach(d => {
                stats[d.date] = { income: d.income, expense: d.expense, count: d.count };
            });
            return stats;
        }
    ...
    return (
        <div className="w-auto -mx-4 border-y border-gray-200 dark:border-white/10">
            ...
            <div className="grid grid-cols-7 text-center py-3 border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-gray-900/50">
