...
const FinanceView: React.FC<FinanceViewProps> = ({ user, onBack, searchQuery = '', isSuspended }) => {
    ...
    return (
        <>
            <main 
                className="relative z-10 h-full overflow-y-auto lg:overflow-y-hidden bg-[#F9F6F2] dark:bg-black pt-20 md:pt-24 px-4 pb-2 scrollbar-hide dev-console-spacing-pb"
                style={{
            ...
            >
                <div className="w-full max-w-[1600px] mx-auto h-full flex flex-col">
                    ...
                    <div className="flex flex-col gap-6 lg:gap-6 flex-1 min-h-0 lg:w-full lg:max-w-[1600px] mx-auto w-full">
