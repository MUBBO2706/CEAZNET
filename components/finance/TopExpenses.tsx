...
const TopExpenses: React.FC<TopExpensesProps> = ({ transactions }) => {
    ...
    return (
        <div className="relative overflow-hidden transition-all duration-300 -mx-4">
            ...
            <div className="flex items-center justify-between mb-3 px-4 relative z-10">
            ...
            <div className="flex flex-col relative z-10">
                {topExpenses.map((t, i) => {
                    ...
                    return (
                        <div 
                            key={t.id} 
                            className="group flex flex-row items-center justify-between px-4 py-3.5 border-b border-gray-100 dark:border-gray-800/80 hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-all duration-300 w-full"
                        >
