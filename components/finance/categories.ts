...
import { 
    ...
    Carrot, Apple, CupSoda, Sandwich, Milk, HelpCircle,
    Activity, Airplay, AlarmClock, Aperture, ArrowRight, AtSign, BadgeCheck, BarChart2,
    Bell, Bookmark, Box, Building, Calculator, Clapperboard, Clipboard, Code,
    Cpu, Database, Disc, DoorOpen, Egg, Eye, Feather, Filter, FlaskConical,
    Footprints, Glasses, Globe, Heart, Image, Layers, Link, Megaphone, Mountain,
    Package, Phone, Radio, Rocket, ScreenShare, Search, Speaker, Stethoscope, Target,
    Terminal, Thermometer, Timer, Volume2, Wine
} from 'lucide-react';
...
export const CATEGORY_CONFIG = {
    expense: [
        ...
        { id: 'Snacks', label: 'Snacks', icon: User, color: colors.yellow.t, bg: colors.yellow.b },
        { id: 'WaterBottle', label: 'Drinking Water', icon: Droplets, color: colors.sky.t, bg: colors.sky.b },
        { id: 'FastFood_Junk', label: 'Burgers & Pizza', icon: Pizza, color: colors.orange.t, bg: colors.orange.b },
    ...
    income: [
        ...
        { id: 'Trading', label: 'Stock Trading', icon: TrendingUp, color: colors.emerald.t, bg: colors.emerald.b },
        { id: 'Youtube', label: 'Youtube Revenue', icon: Video, color: colors.red.t, bg: colors.red.b },
        { id: 'Sponsorship', label: 'Sponsorships', icon: Handshake, color: colors.blue.t, bg: colors.blue.b },
        { id: 'Affiliate', label: 'Affiliate Marketing', icon: Tag, color: colors.pink.t, bg: colors.pink.b },
...
export const LUCIDE_ICON_MAP: Record<string, any> = {
    ...
    Plane, Dumbbell, PawPrint, Wrench, Shield, Smartphone, Wifi, Music, 
    BookOpen, Scissors, Baby, BriefcaseMedical, Landmark, Laptop, 
    Tv, Coffee, Gamepad2, Hammer, Flower, Shirt, GiftIcon,
    DollarSign, PiggyBank, CreditCard, Percent, Video, Mic,
    Coins, User, Handshake, HeartHandshake, Droplets, Wallet, Receipt, PenTool,
    Bus, Train, Fuel, ParkingCircle, Ticket, Hotel, Beer, Cigarette, 
    SprayCan, Sprout, Cat, Dog, Monitor, Server, Cloud, HardDrive,
    ...
    Trophy, Medal, Crown, Star, Gem, Key, Lock, Map, Compass,
    Anchor, Bike, BatteryCharging, Plug, Lightbulb, ShowerHead,
    Pizza, PieChart, Tag, AppWindow, Award, Clover, Sparkles, Palette,
    Carrot, Apple, CupSoda, Sandwich, Milk, HelpCircle,
    Activity, Airplay, AlarmClock, Aperture, ArrowRight, AtSign, BadgeCheck, BarChart2,
    Bell, Bookmark, Box, Building, Calculator, Clapperboard, Clipboard, Code,
    Cpu, Database, Disc, DoorOpen, Egg, Eye, Feather, Filter, FlaskConical,
...
export const AVAILABLE_ICON_NAMES = Object.keys(LUCIDE_ICON_MAP).filter(name => name !== 'HelpCircle');
...
export function getCategoryConfig(
    ...
    if (custom) {
        const IconComp = LUCIDE_ICON_MAP[custom.iconName] || LUCIDE_ICON_MAP.Tag || Sparkles;
        return {
            id: custom.id,
            label: custom.label,
            icon: IconComp,
