...
export const RAW_CATEGORY_CONFIG: {
    ...
    expense: [
        // --- Food & Drink ---
        { id: 'Food', label: 'Dining Out', iconName: 'ph:pizza-duotone', color: colors.orange.t, bg: colors.orange.b },
        { id: 'Groceries', label: 'Groceries', iconName: 'solar:cart-large-minimalistic-bold-duotone', color: colors.green.t, bg: colors.green.b },
        { id: 'Vegetables', label: 'Vegetables', iconName: 'ph:carrot-duotone', color: colors.green.t, bg: colors.green.b },
        { id: 'Fruits', label: 'Fruits', iconName: 'ph:apple-logo-duotone', color: colors.red.t, bg: colors.red.b },
        ...
        { id: 'Snacks', label: 'Snacks', iconName: 'ph:cookie-duotone', color: colors.yellow.t, bg: colors.yellow.b },
        ...
        // --- Transport ---
        { id: 'Transport', label: 'Public Transport', iconName: 'solar:bus-bold-duotone', color: colors.blue.t, bg: colors.blue.b },
        { id: 'Fuel', label: 'Fuel / Gas', iconName: 'ph:gas-pump-duotone', color: colors.red.t, bg: colors.red.b },
        ...
        // --- Housing & Utilities ---
        { id: 'Rent', label: 'Rent', iconName: 'solar:home-smile-bold-duotone', color: colors.teal.t, bg: colors.teal.b },
        { id: 'Electricity', label: 'Electricity Bill', iconName: 'ph:lightning-duotone', color: colors.yellow.t, bg: colors.yellow.b },
        { id: 'Water', label: 'Water Bill', iconName: 'ph:drop-duotone', color: colors.cyan.t, bg: colors.cyan.b },
        ...
        { id: 'Maintenance_Home', label: 'Home Repairs', iconName: 'tabler:tools', color: colors.gray.t, bg: colors.gray.b },
        ...
        { id: 'Insurance', label: 'Insurance', iconName: 'solar:shield-check-bold-duotone', color: colors.emerald.t, bg: colors.emerald.b },
        ...
        // --- Tech ---
        { id: 'Mobile', label: 'Mobile Bill', iconName: 'solar:smartphone-bold-duotone', color: colors.zinc.t, bg: colors.zinc.b },
        { id: 'Gadgets', label: 'Electronics', iconName: 'solar:laptop-minimalistic-bold-duotone', color: colors.slate.t, bg: colors.slate.b },
        { id: 'Software', label: 'Software / Apps', iconName: 'solar:code-square-bold-duotone', color: colors.blue.t, bg: colors.blue.b },
        ...
        // --- Social & Gifts ---
        { id: 'Gift', label: 'Gifts', iconName: 'solar:gift-bold-duotone', color: colors.pink.t, bg: colors.pink.b },
        { id: 'Donation', label: 'Charity / Donation', iconName: 'solar:heart-angle-bold-duotone', color: colors.rose.t, bg: colors.rose.b },
        { id: 'Tip', label: 'Tips', iconName: 'ph:coins-duotone', color: colors.yellow.t, bg: colors.yellow.b },
        { id: 'Udhar_Given', label: 'Lent (Udhar)', iconName: 'solar:hand-money-bold-duotone', color: colors.rose.t, bg: colors.rose.b },
        ...
        // --- Miscellaneous ---
        { id: 'Vacation', label: 'Travel / Vacation', iconName: 'ph:tree-palm-duotone', color: colors.sky.t, bg: colors.sky.b },
        { id: 'Taxes', label: 'Taxes', iconName: 'tabler:receipt-2', color: colors.slate.t, bg: colors.slate.b },
        { id: 'Fines', label: 'Fines / Challan', iconName: 'solar:danger-triangle-bold-duotone', color: colors.red.t, bg: colors.red.b },
    ...
    income: [
        { id: 'MobileRepair', label: 'Mobile Repair', iconName: 'tabler:device-mobile-cog', color: colors.cyan.t, bg: colors.cyan.b },
        { id: 'Balance', label: 'Balance', iconName: 'solar:scale-bold-duotone', color: colors.teal.t, bg: colors.teal.b },
        { id: 'Salary', label: 'Salary', iconName: 'solar:hand-money-bold-duotone', color: colors.green.t, bg: colors.green.b },
        ...
        { id: 'Affiliate', label: 'Affiliate Marketing', iconName: 'solar:tag-price-bold-duotone', color: colors.pink.t, bg: colors.pink.b },
        ...
        { id: 'Rental', label: 'Rental Income', iconName: 'solar:home-2-bold-duotone', color: colors.teal.t, bg: colors.teal.b },
        { id: 'Sale', label: 'Sold Items', iconName: 'solar:shop-bold-duotone', color: colors.cyan.t, bg: colors.cyan.b }, 
        { id: 'Cashback', label: 'Cashback / Rewards', iconName: 'solar:restart-bold-duotone', color: colors.cyan.t, bg: colors.cyan.b },
        { id: 'Gift_In', label: 'Gift Received', iconName: 'solar:gift-bold-duotone', color: colors.pink.t, bg: colors.pink.b },
        ...
        { id: 'Grant', label: 'Grant / Scholarship', iconName: 'solar:medal-star-bold-duotone', color: colors.yellow.t, bg: colors.yellow.b },
        { id: 'Lottery', label: 'Lottery / Betting', iconName: 'ph:clover-duotone', color: colors.green.t, bg: colors.green.b },
    ...
    transfer: [
        ...
        { id: 'Withdrawal', label: 'ATM Withdrawal', iconName: 'hugeicons:atm-01', color: colors.green.t, bg: colors.green.b },
        { id: 'Other', label: 'Other', iconName: 'solar:menu-dots-bold-duotone', color: colors.gray.t, bg: colors.gray.b },
    ]
};
...
export function getCategoryConfig(
    categoryId: string, 
    type?: string, 
    customCategories: Array<{ id: string; label: string; iconName: string; color?: string; bg?: string; isCustom?: boolean }> = []
) {
    if (!categoryId) return null;

    // 1. Check custom categories
    const custom = customCategories.find(c => c.id.toLowerCase() === categoryId.toLowerCase() || c.label.toLowerCase() === categoryId.toLowerCase());
    if (custom) {
        const IconComp = createUniversalIconComponent(custom.iconName || 'solar:tag-bold-duotone');
        return {
            id: custom.id,
            label: custom.label,
            icon: IconComp,
            iconName: custom.iconName,
            color: custom.color || 'text-indigo-500',
            bg: custom.bg || 'bg-indigo-100 dark:bg-indigo-900/30',
            isCustom: true
        };
    }

    // 2. Check standard categories
    const listType = (type && CATEGORY_CONFIG[type as keyof typeof CATEGORY_CONFIG]) 
        ? CATEGORY_CONFIG[type as keyof typeof CATEGORY_CONFIG] 
        : [...CATEGORY_CONFIG.expense, ...CATEGORY_CONFIG.income, ...CATEGORY_CONFIG.transfer];
    
    const standard = listType.find(c => c.id.toLowerCase() === categoryId.toLowerCase() || c.label.toLowerCase() === categoryId.toLowerCase());
    if (standard) {
        return standard;
    }
