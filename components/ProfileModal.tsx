...
import { X, LoaderCircle, Camera, User as UserIcon, Mail, Sparkles, LogOut } from 'lucide-react';
...
const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose, user, userProfile, onProfileUpdate, onLogout }) => {
                ...
                <div className="relative bg-white/90 dark:bg-black backdrop-blur-xl rounded-[1.8rem] shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden">
                    ...
                    <div className="px-8 pt-8 pb-6">
                        ...
                        <button
                            ...
                            className="mt-6 group relative w-full flex items-center justify-center py-3.5 bg-neutral-900 dark:bg-white text-white dark:text-black font-bold rounded-xl overflow-hidden transition-all hover:shadow-lg hover:shadow-blue-500/20 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                        ...
                        {onLogout && (
                            <button
                                ...
                                type="button"
                                className="mt-3 group relative w-full flex items-center justify-center py-2.5 bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 font-semibold rounded-xl border border-red-200/60 dark:border-red-500/20 transition-all hover:bg-red-100 dark:hover:bg-red-500/20 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed text-xs"
                            >
                                {isLoggingOut ? (
