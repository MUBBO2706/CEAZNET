...
const ArticleCard = React.forwardRef<HTMLDivElement, ArticleCardProps>(({ 
    ...
    // Enable dynamic colors for both stack and grid
    const enableDynamicColors = true;
                ...
                <div className="p-3">
                 ...
                 <div className="flex-1 px-5 pb-5 flex flex-col">
                    ...
                    <div className="mt-auto pt-4 flex items-center justify-between">
                        ...
                        <button 
                            onClick={(e) => { stopPropagation(e); onBookmark(); }} 
                            className={`p-2 -m-2 transition-colors ${
                                isBookmarked 
                                    ? 'text-amber-500 dark:text-amber-400' 
                                    : variant === 'grid' 
                                        ? 'text-neutral-400 dark:text-gray-500 hover:text-amber-500 dark:hover:text-amber-400' 
                                        : 'hover:text-amber-400'
                            }`} 
                            style={!isBookmarked ? subTextStyle : undefined}
