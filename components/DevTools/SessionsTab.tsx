...
export const SessionsTab: React.FC<SessionsTabProps> = ({ 
    ...
    return (
        <div className="flex-1 flex flex-col h-full overflow-hidden w-full bg-[var(--dev-console-bg)] relative">
            ...
            <div className="flex-none border-b border-[var(--dev-console-border)] bg-[var(--dev-console-bg-hover)] w-full relative z-20">
                ...
                <div className="md:hidden flex flex-col gap-2 p-2">
                    <div className="flex items-center gap-2 w-full min-w-0">
                        <div className="flex-1 flex items-center bg-transparent border border-[var(--dev-console-border)] px-2.5 focus-within:border-[#007fd4] transition-colors h-8">
                            <input 
            ...
            {/* Search Match Navigation Toolbar (Bottom Footer) */}
            {sessionCacheSearch && sessionCacheSearch.trim() && (
                <div className="flex-none h-9 border-t border-[var(--dev-console-border)] bg-[var(--dev-console-bg)] py-1.5 px-4 flex items-center justify-between gap-4 font-sans text-xs select-none relative z-40">
