        ...
        >
            ...
            <div className="flex justify-between items-start gap-2 flex-shrink-0">
                ...
                <button 
                    ...
                    className={`
                        p-1 -mt-1 -mr-1 transition-colors duration-200 flex-shrink-0
                        ${note.isPinned 
                ...
                <div className="flex items-center justify-between transition-opacity">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <InlineConfirmDelete 
                            ...
                            iconOnly 
                            className="p-1 -mr-1 text-neutral-400 hover:text-red-500 dark:text-neutral-500 dark:hover:text-red-400 transition-colors"
                            iconClassName="w-3.5 h-3.5"
                            onConfirmStateChange={setIsConfirmingDelete}
                        />
                    </div>
                </div>
            </div>
