    ...
    <div className="w-full h-full flex flex-col bg-white dark:bg-black overflow-hidden hover:bg-white dark:hover:bg-black transition-colors">
                                                            ...
                                                            <div className="relative shrink-0 z-30">
                                                                ...
                                                                {activeMenuMsgId === msg.id && (
                                                                    <>
                                                                        ...
                                                                        />
                                                                        <div className="absolute right-0 mt-1 w-32 bg-white dark:bg-[#121212] rounded-xl shadow-xl border border-neutral-100 dark:border-neutral-800 py-1.5 z-20 origin-top-right">
                                                                            {isUser ? (
                                                                                <>
                                                                                    <button 
                                                                                    ...
                                                                                    >
                                                                                        <Braces className="w-3.5 h-3.5 text-neutral-400" />
                                                                                        Edit
                                                                                    </button>
                                                                                    <button 
                                                                                ...
                                                                                <div className="px-3 py-2 text-[11px] text-neutral-400 dark:text-neutral-500 font-medium">
                                                                                    Cannot edit replies
                                                                                </div>
                                                                            )}
                                                                        </div>
      ...
      {(!activeConversation && !isComposing) && (
          <button 
              ...
              className="fixed bottom-6 right-6 z-40 w-16 h-16 bg-neutral-900 dark:bg-white text-white dark:text-black rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 group md:hidden"
