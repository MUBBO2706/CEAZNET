...
import { LogOut, UserCog, LogIn, X, Bookmark, Loader, Search, Eye, Heart, ArrowLeft, Trash2, Upload, Download, RotateCw, Edit2, Check, HeadphonesIcon, Sparkles, ChevronDown, BarChart3 } from 'lucide-react';
