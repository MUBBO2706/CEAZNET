...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
    ...
    const modalContent = (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[99999] p-4 pointer-events-auto" aria-modal="true" onClick={onClose}>
