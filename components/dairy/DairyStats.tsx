...
const DairyStats: React.FC<DairyStatsProps> = ({ item, entries, payments }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 md:gap-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-3 flex-1">
            ...
            {/* Chart */}
            <div className="bg-white dark:bg-[#050505] p-6 md:p-4 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm flex-1 flex flex-col">
                <h3 className="text-lg md:text-base font-semibold text-gray-900 dark:text-white mb-6 md:mb-3">Monthly Expense Trend</h3>
                <div className="h-64 md:h-full w-full min-h-[150px]">
