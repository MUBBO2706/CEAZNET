...
import { X, Save, Calendar, DollarSign, ChevronDown, Trash2, CheckSquare, Square, ListChecks, Loader, Info, CheckCircle, IndianRupee, AlertTriangle } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white dark:bg-[#050505] rounded-2xl w-full max-w-md shadow-xl border border-gray-200 dark:border-gray-800 animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh]">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800 shrink-0">
                    ...
                    {!isSingleEntryMode && initialPayment && onDelete && (
                        <InlineConfirmDelete 
                            onDelete={() => onDelete(initialPayment.id)}
                            iconOnly
