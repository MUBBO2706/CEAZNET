...
const DairyView: React.FC<DairyViewProps> = ({ setDairyHeaderState, isSuspended }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 dark:bg-black overflow-hidden relative">
            {/* Content */}
            <div className="flex-1 overflow-y-auto p-4 md:p-6 pt-20 md:pt-24 pb-6 dev-console-spacing-pb">
                {viewMode === 'dashboard' ? (
                    ...
                    selectedItem && (
                        <div className="space-y-6 w-full max-w-[1600px] mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row gap-6">
                                <div className="bg-white dark:bg-[#050505] rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden flex-1 flex flex-col">
                            ...
                            <div className="bg-white dark:bg-[#050505] rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden flex-1 flex flex-col max-h-[800px]">
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <div className="grid grid-cols-2 gap-4 md:gap-3">
                                                ...
                                                <div className="p-4 md:p-3 bg-purple-50 dark:bg-purple-900/20 rounded-2xl relative overflow-hidden">
                                                    <p className="text-xs text-purple-600 dark:text-purple-400 font-medium mb-1">Total Entries</p>
                                                    <p className="text-xl md:text-lg font-bold text-purple-700 dark:text-purple-300 relative z-10">
                                                        {totalEntriesCount} <span className="text-sm font-medium opacity-70">days</span>
                                                    </p>
                                                </div>
                                                <div className="p-4 md:p-3 bg-orange-50 dark:bg-orange-900/20 rounded-2xl relative overflow-hidden">
                                                    <p className="text-xs text-orange-600 dark:text-orange-400 font-medium mb-1">Missing Days</p>
                                                    <p className="text-xl md:text-lg font-bold text-orange-700 dark:text-orange-300 relative z-10">
                                                        {daysMissing} <span className="text-sm font-medium opacity-70">days</span>
                                                    </p>
                                                </div>
                                                <div className="p-4 md:p-3 bg-teal-50 dark:bg-teal-900/20 rounded-2xl relative overflow-hidden">
                                                    <p className="text-xs text-teal-600 dark:text-teal-400 font-medium mb-1">Avg Daily Cost</p>
                                                    <p className="text-xl md:text-lg font-bold text-teal-700 dark:text-teal-300 relative z-10">
                                                        ₹{avgDailyCost}
                                                    </p>
                                                </div>
                                                <div className="p-4 md:p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl relative overflow-hidden">
                                                    <p className="text-xs text-indigo-600 dark:text-indigo-400 font-medium mb-1">Avg Daily Qty</p>
                                                    <p className="text-xl md:text-lg font-bold text-indigo-700 dark:text-indigo-300 relative z-10">
                                                        {avgDailyQty} <span className="text-sm font-medium opacity-70">{selectedItem.unit}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        );
