...
COMMENT ON COLUMN public.user_settings.voice_recording_enabled 
IS 'True if voice recording is enabled, false if voice input and transcription is disabled';
