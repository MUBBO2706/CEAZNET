...
3. Once validated, the developer clicks **Merge** in the admin panel to apply the changes to Production.
...
2. **API Updates for AI Write Access**:
   ...
   - **WRITE/PUSH Endpoint**: `POST /api/push-task` 
     - Body: `{ "apiKey": "sk_sync_...", "projectId": "<STAGING_PROJECT_ID>", "task": { "title": "...", "sql": "...", "type": "sql" } }`
